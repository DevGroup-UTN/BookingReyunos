...
<h3>Objetivos:</h3>
<p>Integración de distintas universidades nacionales y del exterior mediante el desarrollo de una actividad específica de formación de grado, en un tema común para todas las especialidades de las carreras de Ingeniería, a través de un curso teórico/práctico denominado “Gestión y Desarrollo Territorial” cursado de modo intensivo in-situ en el Centro CTDR “Los Reyunos”.</p>

<h3>Metodología:</h3>
<p>Cursado presencial intensivo, en el Centro Tecnológico de Desarrollo Regional Los Reyunos. Incluye actividad áulica, análisis de maquetas, espacios de reflexión y debate, y visitas técnicas a los laboratorios reales de escala 1:1.</p>
...
<h3>Destinatarios:</h3>
<p>Para alumnos avanzados de cualquiera de las especialidades de las carreras de Ingeniería que estén cursando materias de los últimos años de la carrera. Cada Universidad resolverá la selección definitiva siguiendo parámetros propios a cada realidad local (promedios, participación en actividades de la Facultad, condición de becario, etc.)</p>

<h3>Matrícula:</h3>
<p>Se establece un cupo máximo de cuarenta y cinco (45) personas en total, dentro del cual se consideran incluidos 1 ó 2 docentes a cargo de la delegación y los choferes de los medios de movilidad para el traslado; en el caso que así lo hubiere resuelto la Universidad.</p>
...
<h3>Costos:</h3>
<p>Los costos de las actividades que forman parte del programa serán variables teniendo en cuenta el contenido y la duración del módulo seleccionado por cada universidad. Los mismos incluyen, la estadía (hospedaje en el Complejo con pensión completa; desayunos, almuerzos, meriendas y cenas), las actividades de capacitación (coordinación, carga docente, visitas técnicas locales, material de estudio), y las de recreación (sala juegos, playón deportivo, piscina, Internet y visita a la ciudad). Cada Universidad deberá adicionar al viaje alrededor de 300 Km. extras para los desplazamientos locales. Se suscribirán convenios específicos con el detalle de la actividad a desarrollar y su presupuesto.</p>
<h3>Contenidos:</h3>
<h3>Programa Analítico:</h3>

<h3>Unidad 1:</h3>
<h3>La Ingeniería y el Desarrollo</h3>
<p>Introducción al Desarrollo Local. La Ingeniería, la transdisciplinariedad y el Desarrollo Local. Diagnostico Territorial: Recursos y Actores. Herramientas del Desarrollo Local: Plan Estratégico de Desarrollo, Agencias de Desarrollo, Gestión Asociada, Polos y Parques Tecnológicos, Inclusión Digital, Marca Ciudad, Emprendedorismo y Clusters, Identificación Geográfica Protegida, Identificación, Formulación y Gestión de Proyectos. Responsabilidad Social Empresaria</p>
